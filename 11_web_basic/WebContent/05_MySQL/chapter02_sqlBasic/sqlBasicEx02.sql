...
FROM
		PRODUCT
WHERE
		REG_DT >= '2021-01-01'; # 데이터베이스는 날짜 비교 가능
...
FROM
		PRODUCT
WHERE
		PRICE >= 20000 AND PRICE <= 50000 AND REG_DT>'2021-00-00' AND REG_DT<='2021-12-31';
...
FROM
		PRODUCT
WHERE
		(REG_DT>'2021-00-00' AND REG_DT<='2021-03-31') OR 
        (REG_DT>'2020-00-00' AND REG_DT<='2020-03-31');
...
FROM
		PRODUCT
WHERE
		PRODUCT_CD <> 'P10001' AND PRODUCT_CD <> 'P10003' AND PRODUCT_CD <> 'P10005';
