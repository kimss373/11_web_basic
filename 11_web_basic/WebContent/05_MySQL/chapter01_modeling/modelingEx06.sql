...
INSERT INTO TEST1(PRODUCT_CD , PRODUCT_NM) VALUES(6 , '상품6'); 				 # SUCCECC
...
INSERT INTO TEST4 VALUES(10 , '상품10' , 10000 , '2022-12-31');	 # SUCCESS
INSERT INTO TEST4(PRODUCT_NM) VALUES('상품11');				     # SUCCESS
INSERT INTO TEST4(PRODUCT_NM) VALUES('상품10');	 # SUCCESS
SELECT * FROM TEST4;
...
INSERT INTO TEST6_2 VALUES ('O6' , '유저1' , 4); 	# 메인테이블과 참조테이블 사이 데이터의 차이가 발생
INSERT INTO TEST6_2 VALUES ('O7' , '유저2' , 5); 	# 메인테이블과 참조테이블 사이 데이터의 차이가 발생

UPDATE TEST6_1 SET PRODUCT_CD = 11 WHERE PRODUCT_CD = 1; # 메인테이블과 참조테이블 사이 데이터의 차이가 발생
UPDATE TEST6_1 SET PRODUCT_CD = 22 WHERE PRODUCT_CD = 2; # 메인테이블과 참조테이블 사이 데이터의 차이가 발생
DELETE FROM TEST6_1 WHERE PRODUCT_CD = 3;                # 메인테이블과 참조테이블 사이 데이터의 차이가 발생
...
INSERT INTO TEST7_2 VALUES ('O6' , '유저1' , 4); 	# KEY 참조 제약 위반 (메인키에 없는 데이터)
INSERT INTO TEST7_2 VALUES ('O7' , '유저2' , 5); 	# KEY 참조 제약 위반 (메인키에 없는 데이터)

UPDATE TEST7_1 SET PRODUCT_CD = 11 WHERE PRODUCT_CD = 1; # 참조키가 있을 경우 메인키의 데이터만 수정 불가
UPDATE TEST7_1 SET PRODUCT_CD = 22 WHERE PRODUCT_CD = 2; # 참조키가 있을 경우 메인키의 데이터만 수정 불가
DELETE FROM TEST7_1 WHERE PRODUCT_CD = 3;                # 참조키가 있을 경우 메인키의 데이터만 수정 불가
...
CREATE TABLE TEST8_2(
    ...
    MEMBER_ID VARCHAR(20),
    PRODUCT_CD INT,
    CONSTRAINT PRODUCT_CD_REF2 FOREIGN KEY(PRODUCT_CD) REFERENCES TEST8_1(PRODUCT_CD)
...
INSERT INTO TEST8_2 VALUES ('O6' , '유저1' , 4); 	# KEY 참조 제약 위반 (메인키에 없는 데이터) 
INSERT INTO TEST8_2 VALUES ('O7' , '유저2' , 5); 	# KEY 참조 제약 위반 (메인키에 없는 데이터) 
